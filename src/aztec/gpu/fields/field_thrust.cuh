...
namespace gpu_barretenberg_thrust {
...
class field_single {
    public:  
        ...
        // Load and store can be replicated with thrust::device_vector::copy
        ...
        __device__ __forceinline__ static void sub_inplace(uint254 &af, const thrust::device_vector<var> b);
        ...
        __device__ __forceinline__ static void store(thrust::device_vector<uint254> mem, const uint254 &x);  
