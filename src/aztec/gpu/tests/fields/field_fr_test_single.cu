...
__global__ void initialize_mont_mult(uint254 &a, uint254 &b, uint254 &expected) {
    a = { 0x192f9ddc938ea63, 0x1db93d61007ec4fe, 0xc89284ec31fa49c0, 0x2478d0ff12b04f0f };
    b = { 0x7aade4892631231c, 0x8e7515681fe70144, 0x98edb76e689b6fd8, 0x5d0886b15fc835fa };
    expected = { 0xab961ef46b4756b6, 0xbc6b636fc29678c8, 0xd247391ed6b5bd16, 0x12e8538b3bde6784 };
}
...
__global__ void initialize_add_check_against_constants(uint254 &a, uint254 &b, uint254 &expected) {
    a = { 0x20565a572c565a66, 0x7bccd0f01f5f7bff, 0x63ec2beaad64711f, 0x624953caaf44a814 };
    b = { 0xa17307a2108adeea, 0x74629976c14c5e2b, 0x9ce6f072ab1740ee, 0x398c753702b2bef0 };
    expected = { 0x7de76c654ce1394f, 0xc7fb821e66f26999, 0x4882d6a6d6fa59b0, 0x6b717a8ed0c5c6db };
}
...
__global__ void initialize_sub_check_against_constants(uint254 &a, uint254 &b, uint254 &expected) {
    a = { 0xcfbcfcf457cf2d38, 0x7b27af26ce62aa61, 0xf0378e90d48f2b92, 0x4734b22cb21ded };
    b = { 0x569fdb1db5198770, 0x446ddccef8347d52, 0xef215227182d22a, 0x8281b4fb109306 };
    expected = { 0xbcff176a92b5a5c9, 0x5eedbaa04fe79da0, 0x9995bf24e48db1c5, 0x3029017012d32b11 };
}
...
__global__ void initialize_to_montgomery_form(uint254 &a, uint254 &expected) {
    ...
    expected = { 0xac96341c4ffffffb, 0x36fc76959f60cd29, 0x666ea36f7879462e, 0xe0a77c19a07df2f };
}
...
__global__ void cube(uint254 &a, uint254 &expected, uint254 &result) {
    ...
    fq_single::mul(a, gpu_barretenberg::CUBE_ROOT_SCALAR, expected);
    beta_x = expected;
